...
const ExchangeDetails = React.lazy(() => import("../pages/orders/containers/exchange-details.screen"));
...
const authProtectedRoutes = [
  ...
  // Transactions modules
  { path: "/exchanges/all", component: Exchanges },
  { path: "/exchange-details/:id", component: ExchangeDetails },
  { path: "/withdrawals/all", component: Withdrawals },

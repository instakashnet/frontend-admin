...
export const ClientDetailsScreen = (props) => {
  ...
  if (modalType === "companyProfile") ModalComponent = <CompanyProfile dispatch={dispatch} userId={id} isProcessing={isProcessing} closeModal={closeModal} details={coProfileDetails} />;
  ...
  if (modalType === "editBankAccount") ModalComponent = <EditBankAccount dispatch={dispatch} userId={id} bankAccToEdit={userBankAccEdit} isProcessing={isProcessing} closeModal={closeModal} />;
            ...
            {details?.completed ? (
              <>
                <Row>
                  ...
                  <UserAccounts accounts={accounts} isLoading={isLoading} userBankAccEdit={userBankAccEdit} setUserBankAccEdit={setUserBankAccEdit} openModal={openModal} closeModal={closeModal} dispatch={dispatch} />
                </Row>
                <>
                  <Row>

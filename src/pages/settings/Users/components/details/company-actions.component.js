...
const CompanyActions = ({ company, openModal, deleteProfile }) => {
  ...
  return (
    <div className="mb-3">
      <figure className={`m-0 text-center ${!company ? "cursor-pointer" : ""}`} onClick={() => !company && openModal("companyProfile")}>
      ...
      {company && (
        <div className="text-center">
          <button className={`mr-3 ${sharedClasses.editBtn}`} onClick={() => openModal("companyProfile", company)}>

...
export const OrdersRelationForm = ({ isProcessing, excelType, dispatch }) => {
      ...
      {excelType === 'coupon' ? (
        ...
        <>
          ...
          <div className='flex items-center justify-center'>
            <Checkbox
              name='balanceFlag'
              value={formik.values.balanceFlag}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              label='Agregar utilidad diaria'
            />
          </div>

          {formik.values.balanceFlag && (
            <>

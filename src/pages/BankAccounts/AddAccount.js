...
const AddAccounts = (props) => {
  ...
  const formik = useFormik({ initialValues: CbAccountValues, validationSchema: validateCbAccountValues, onSubmit: (values) => dispatch(addCbAccount(values, props.setAddState)) });
